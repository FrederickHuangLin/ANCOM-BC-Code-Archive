...
p1=ggplot(dat.fig, aes(x=prop.diff, y=FDR, fill=method)) +
  ...
  guides(fill=guide_legend(nrow=2, byrow=TRUE))
ggarrange(p1, labels = "a")
ggsave("../figures/Figure S3a.pdf", width=6.25, height=5, units='in')
ggsave("../figures/Figure S3a.jpeg", width=6.25, height=5, units='in', dpi = 300)
```
...
p2=ggplot(dat.fig, aes(x=prop.diff, y=power, fill=method)) +
  ...
  guides(fill=guide_legend(nrow=2, byrow=TRUE))
ggarrange(p2, labels = "b")
ggsave("../figures/Figure S3b.pdf", width=6.25, height=5, units='in')
ggsave("../figures/Figure S3b.jpeg", width=6.25, height=5, units='in', dpi = 300)
```
...
p = ggarrange(p1 + labs(x=NULL), p2 + labs(x=NULL),
              ...
              common.legend = TRUE, legend="bottom")
annotate_figure(p, left = text_grob("Proportion of Differentially Abundant Taxa", rot = 90))
ggsave("../figures/Figure S3.pdf", width=6.25, height=9, units='in')
ggsave("../figures/Figure S3.jpeg", width=6.25, height=9, units='in', dpi = 300)
```
...
p = ggarrange(p1 + labs(x=NULL), p2 + labs(x=NULL),
              ...
              common.legend = TRUE, legend="bottom")
annotate_figure(p, left = text_grob("Proportion of Differentially Abundant Taxa", rot = 90))
ggsave("../figures/Figure S4.pdf", width=6.25, height=9, units='in')
ggsave("../figures/Figure S4.jpeg", width=6.25, height=9, units='in', dpi = 300)
```

# 5. FDR and Power with the Presence of Large Variable Sampling Fractions Using BH Procedure
...
p1=ggplot(dat.fig, aes(x=prop.diff, y=FDR, fill=method)) +
  ...
  guides(fill=guide_legend(nrow=2, byrow=TRUE))
ggarrange(p1, labels = "a")
ggsave("../figures/Figure S10a.pdf", width=6.25, height=5, units='in')
ggsave("../figures/Figure S10a.jpeg", width=6.25, height=5, units='in', dpi = 300)
```
...
p2=ggplot(dat.fig, aes(x=prop.diff, y=power, fill=method)) +
  ...
  guides(fill=guide_legend(nrow=2, byrow=TRUE))
ggarrange(p2, labels = "b")
ggsave("../figures/Figure S10b.pdf", width=6.25, height=5, units='in')
ggsave("../figures/Figure S10b.jpeg", width=6.25, height=5, units='in', dpi = 300)
```
...
p = ggarrange(p1 + labs(x=NULL), p2 + labs(x=NULL),
              ...
              common.legend = TRUE, legend="bottom")
annotate_figure(p, left = text_grob("Proportion of Differentially Abundant Taxa", rot = 90))
ggsave("../figures/Figure S10.pdf", width=6.25, height=9, units='in')
ggsave("../figures/Figure S10.jpeg", width=6.25, height=9, units='in', dpi = 300)
```
