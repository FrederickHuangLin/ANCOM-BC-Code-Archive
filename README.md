...
The current code implements ANCOM-BC in cross-sectional datasets for comparing changes of absolute abundance for each taxon among different experimental groups. 
